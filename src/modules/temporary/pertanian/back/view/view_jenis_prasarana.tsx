...
import funGetJenisPrasarana from "../fun/get_jenis_prasarana"
import TableJenisPrasarana from "../component/table_jenis_prasarana"
import { useRouter } from "next/navigation"

export default function ViewJenisPrasarana({ provinsi, download, table }: { provinsi: any, download: any, table: any }) {
    ...
    async function onProses() {
        const loadData = await funGetJenisPrasarana({ provinsi: isProvinsi, kab: isKabupaten })
    ...
    return (
        <>
            <Stack>
                <Text fw={"bold"}>PERTANIAN - JENIS PRASARANA TRANSPORTASI KE LOKASI SENTRA PRODUKSI</Text>
            </Stack>
            <Box pt={30}>
                <SimpleGrid
                ...
                >
                    ...
                    >
                        <Box
                            ...
                            onClick={() => router.push("/dashboard/se/upload/jenis-prasarana-transportasi")}
                        >
            ...
            <Box pt={30}>
                <TableJenisPrasarana data={dataTable.data} title={dataTable.title} th={dataTable.thTitle} />
            </Box>
        </>
    )
}