...
export default function TableJenisPrasarana({ title, data, th }: { title: string, data: any, th: any }) {
                                    ...
                                    <Table.Tbody>
                                        {isData.map((v: any, i: any) => (
                                            <Table.Tr key={i}>
                                                ...
                                                <Table.Td>{v.diperkeras}</Table.Td>
                                                <Table.Td>{v.aspal}</Table.Td>
                                                <Table.Td>{v.tanah}</Table.Td>
                                                <Table.Td>{v.tidakTerdefinisi}</Table.Td>
                                            </Table.Tr>
                                        ))}
                                    </Table.Tbody>
                                </Table>
