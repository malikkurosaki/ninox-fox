...
export default function ViewUploadJalanDilaluiKendaraan() {
    ...
    return (
        <>
            ...
            <Stack p={"md"}>
                ...
                >
                    <Text fw={"bold"} c={"white"} mb={20}>UPLOAD DATA JALAN DARAT DAPAT DILALUI KENDARAAN BERMOTOR RODA 4 ATAU LEBIH</Text>
                    <Dropzone
                        loading={isLoading}
                        style={{
                            border: "1px dashed",
            ...
            >
                <ModalUploadTransportasi kategori={"jalan dilalui kendaraan"} data={json} onSuccess={(val) => {
                    setJson([])
                }} />
            </Modal>
        </>
