...
export default function ViewUploadKecelakaan() {
    ...
    return (
        <>
            ...
            <Stack p={"md"}>
                ...
                >
                    <Text fw={"bold"} c={"white"} mb={20}>UPLOAD DATA ANGKA KECELAKAAN LALU LINTAS</Text>
                    <Dropzone
                        loading={isLoading}
                        style={{
                            border: "1px dashed",
            ...
            >
                <ModalUploadTransportasi kategori={"kecelakaan"} data={json} onSuccess={(val) => {
                    setJson([])
                }} />
            </Modal>
        </>
