...
import funGetKecelakaan from "../fun/get_kecelakaan"
import TableKecelakaan from "../component/table_kecelakaan"
import { useRouter } from "next/navigation"

export default function ViewKecelakaan({ provinsi, download, table }: { provinsi: any, download: any, table: any }) {
    ...
    async function onProses() {
        const loadData = await funGetKecelakaan({ provinsi: isProvinsi, kab: isKabupaten })
    ...
    return (
        <>
            <Stack>
                <Text fw={"bold"}>TRANSPORTASI - DATA ANGKA KECELAKAAN</Text>
            </Stack>
            <Box pt={30}>
                <SimpleGrid
                ...
                >
                    ...
                    >
                        <Box
                            ...
                            onClick={() => router.push("/dashboard/se/upload/kecelakaan")}
                        >
            ...
            <Box pt={30}>
                <TableKecelakaan data={dataTable.data} title={dataTable.title} th={dataTable.thTitle} />
            </Box>
        </>
    )
}