...
export default function ViewUploadGuruTersertifikasi() {
    ...
    return (
        <>
            ...
            <Stack p={"md"}>
                ...
                >
                    <Text fw={"bold"} c={"white"} mb={20}>UPLOAD DATA GURU TERSERTIFIKASI</Text>
                    <Dropzone
                        loading={isLoading}
                        style={{
                            border: "1px dashed",
            ...
            >
                <ModalUploadPendidikan kategori={"guru tersertifikasi"} data={json} onSuccess={(val) => {
                    setJson([])
                }} />
            </Modal>
        </>
