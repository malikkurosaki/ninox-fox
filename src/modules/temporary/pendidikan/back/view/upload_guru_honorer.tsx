...
export default function ViewUploadGuruHonorer() {
    ...
    return (
        <>
            ...
            <Stack p={"md"}>
                ...
                >
                    <Text fw={"bold"} c={"white"} mb={20}>UPLOAD DATA GURU HONORER</Text>
                    <Dropzone
                        loading={isLoading}
                        style={{
                            border: "1px dashed",
            ...
            >
                <ModalUploadPendidikan kategori={"guru honorer"} data={json} onSuccess={(val) => {
                    setJson([])
                }} />
            </Modal>
        </>
