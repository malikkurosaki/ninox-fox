...
export default function ViewUploadJalanKakiKurang4Jam() {
    ...
    async function onLoad(data: any) {
        if (data.length > 0) {
            ...
            if (('id' in data[0]) &&
                ...
                ('Kabkot' in data[0]) &&
                ('Kecamatan' in data[0]) &&
                ('FasilitasBeradaDalamDesa' in data[0])) {
    ...
    return (
        <>
            ...
            <Stack p={"md"}>
                ...
                >
                    <Text fw={"bold"} c={"white"} mb={20}>UPLOAD DATA BERJALAN KAKI KURANG DARI 4 JAM UNTUK MENCAPAI SD</Text>
                    <Dropzone
                        loading={isLoading}
                        style={{
                            border: "1px dashed",
                                                ...
                                                <Table.Tbody>
                                                    {json.map(home =>
                                                        <Table.Tr key={home.id}>
                                                            ...
                                                            <Table.Td>{home.FasilitasBeradaDalamDesa}</Table.Td>
                                                        </Table.Tr>
                                                    )}
                                                </Table.Tbody>
                                            </Table>
            ...
            >
                <ModalUploadPendidikan kategori={"jalan kaki kurang 4 jam"} data={json} onSuccess={(val) => {
                    setJson([])
                }} />
            </Modal>
        </>
