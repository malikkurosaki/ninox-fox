...
import funGetLembagaKeuangan from "../fun/get_lembaga_keuangan"
import TableLembagaKeuangan from "../component/table_lembaga_keuangan"
import { useRouter } from "next/navigation"

export default function ViewLembagaKeuangan({ provinsi, download, table }: { provinsi: any, download: any, table: any }) {
    ...
    async function onProses() {
        const loadData = await funGetLembagaKeuangan({ provinsi: isProvinsi, kab: isKabupaten })
    ...
    return (
        <>
            <Stack>
                <Text fw={"bold"}>EKONOMI - KETERSEDIAAN LEMBAGA KEUANGAN</Text>
            </Stack>
            <Box pt={30}>
                <SimpleGrid
                ...
                >
                    ...
                    >
                        <Box
                            ...
                            onClick={() => router.push("/dashboard/se/upload/lembaga-keuangan")}
                        >
            ...
            <Box pt={30}>
                <TableLembagaKeuangan data={dataTable.data} title={dataTable.title} th={dataTable.thTitle} />
            </Box>
        </>
    )
}