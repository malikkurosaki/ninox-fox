...
import funGetJumlahPasar from "../fun/get_jumlah_pasar"
import TableJumlahPasar from "../component/table_jumlah_pasar"
import { useRouter } from "next/navigation"

export default function ViewJumlahPasar({ provinsi, download, table }: { provinsi: any, download: any, table: any }) {
    ...
    async function onProses() {
        const loadData = await funGetJumlahPasar({ provinsi: isProvinsi, kab: isKabupaten })
    ...
    return (
        <>
            <Stack>
                <Text fw={"bold"}>EKONOMI - JUMLAH PASAR BERDASARKAN JENIS BANGUNAN</Text>
            </Stack>
            <Box pt={30}>
                <SimpleGrid
                ...
                >
                    ...
                    >
                        <Box
                            ...
                            onClick={() => router.push("/dashboard/se/upload/jumlah-pasar")}
                        >
            ...
            <Box pt={30}>
                <TableJumlahPasar data={dataTable.data} title={dataTable.title} th={dataTable.thTitle} />
            </Box>
        </>
    )
}