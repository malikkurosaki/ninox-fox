...
import ModalUploadKemiskinan from "../component/modal_kemiskinan"

export default function ViewUploadDataKemiskinan() {
    ...
    return (
        <>
            ...
            <Stack p={"md"}>
                ...
                >
                    <Text fw={"bold"} c={"white"} mb={20}>UPLOAD DATA KEMISKINAN</Text>
                    <Dropzone
                        loading={isLoading}
                        style={{
                            border: "1px dashed",
            ...
            >
                <ModalUploadKemiskinan kategori={"data kemiskinan"} data={json} onSuccess={(val) => {
                    setJson([])
                }} />
            </Modal>
        </>
