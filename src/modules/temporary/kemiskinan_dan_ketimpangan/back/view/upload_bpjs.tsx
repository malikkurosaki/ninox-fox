...
export default function ViewUploadBpjs() {
    ...
    return (
        <>
            ...
            <Stack p={"md"}>
                ...
                >
                    <Text fw={"bold"} c={"white"} mb={20}>UPLOAD DATA PESERTA BPJS KESEHATAN</Text>
                    <Dropzone
                        loading={isLoading}
                        style={{
                            border: "1px dashed",
            ...
            >
                <ModalUploadKemiskinan kategori={"bpjs"} data={json} onSuccess={(val) => {
                    setJson([])
                }} />
            </Modal>
        </>
