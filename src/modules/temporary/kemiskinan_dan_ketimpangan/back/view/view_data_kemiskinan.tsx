...
import funGetDataKemiskinan from "../fun/get_data_kemiskinan"
import TableDataKemiskinan from "../component/table_data_kemiskinan"
import { useRouter } from "next/navigation"

export default function ViewDataKemiskinan({ provinsi, download, table }: { provinsi: any, download: any, table: any }) {
    ...
    async function onProses() {
        const loadData = await funGetDataKemiskinan({ provinsi: isProvinsi, kab: isKabupaten })
    ...
    return (
        <>
            <Stack>
                <Text fw={"bold"}>KEMISKINAN - DATA KEMISKINAN</Text>
            </Stack>
            <Box pt={30}>
                <SimpleGrid
                ...
                >
                    ...
                    >
                        <Box
                            ...
                            onClick={() => router.push("/dashboard/se/upload/data-kemiskinan")}
                        >
            ...
            <Box pt={30}>
                <TableDataKemiskinan data={dataTable.data} title={dataTable.title} th={dataTable.thTitle} />
            </Box>
        </>
    )
}