...
export default function ViewUploadNarkoba() {
    ...
    return (
        <>
            ...
            <Stack p={"md"}>
                ...
                >
                    <Text fw={"bold"} c={"white"} mb={20}>UPLOAD DATA INTENSITAS PEREDARAN NARKOBA</Text>
                    <Dropzone
                        loading={isLoading}
                        style={{
                            border: "1px dashed",
            ...
            >
                <ModalUploadKeamanan kategori={"narkoba"} data={json} onSuccess={(val) => {
                    setJson([])
                }} />
            </Modal>
        </>
