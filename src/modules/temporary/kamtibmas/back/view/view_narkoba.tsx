...
import funGetNarkoba from "../fun/get_narkoba"
import TableNarkoba from "../component/table_narkoba"
import { useRouter } from "next/navigation"

export default function ViewNarkoba({ provinsi, download, table }: { provinsi: any, download: any, table: any }) {
    ...
    async function onProses() {
        const loadData = await funGetNarkoba({ provinsi: isProvinsi, kab: isKabupaten })
    ...
    return (
        <>
            <Stack>
                <Text fw={"bold"}>KEAMANAN - INTENSITAS PEREDARAN NARKOBA</Text>
            </Stack>
            <Box pt={30}>
                <SimpleGrid
                ...
                >
                    ...
                    >
                        <Box
                            ...
                            onClick={() => router.push("/dashboard/se/upload/narkoba")}
                        >
            ...
            <Box pt={30}>
                <TableNarkoba data={dataTable.data} title={dataTable.title} th={dataTable.thTitle} />
            </Box>
        </>
    )
}