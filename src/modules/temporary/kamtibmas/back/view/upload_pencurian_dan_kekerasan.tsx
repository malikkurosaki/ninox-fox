...
export default function ViewUploadPencurianDanKekerasan() {
    ...
    return (
        <>
            ...
            <Stack p={"md"}>
                ...
                >
                    <Text fw={"bold"} c={"white"} mb={20}>UPLOAD DATA INTENSITAS PENCURIAN DAN KEKERASAN</Text>
                    <Dropzone
                        loading={isLoading}
                        style={{
                            border: "1px dashed",
            ...
            >
                <ModalUploadKeamanan kategori={"pencurian dan kekerasan"} data={json} onSuccess={(val) => {
                    setJson([])
                }} />
            </Modal>
        </>
