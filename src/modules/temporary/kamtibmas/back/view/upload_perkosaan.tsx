...
export default function ViewUploadPerkosaan() {
    ...
    return (
        <>
            ...
            <Stack p={"md"}>
                ...
                >
                    <Text fw={"bold"} c={"white"} mb={20}>UPLOAD DATA INTENSITAS KEJAHATAN PERKOSAAN/ASUSILA</Text>
                    <Dropzone
                        loading={isLoading}
                        style={{
                            border: "1px dashed",
            ...
            >
                <ModalUploadKeamanan kategori={"perkosaan"} data={json} onSuccess={(val) => {
                    setJson([])
                }} />
            </Modal>
        </>
