...
export default function ViewUploadPerkelahian() {
    ...
    return (
        <>
            ...
            <Stack p={"md"}>
                ...
                >
                    <Text fw={"bold"} c={"white"} mb={20}>UPLOAD DATA INTENSITAS PERKELAHIAN MASSAL</Text>
                    <Dropzone
                        loading={isLoading}
                        style={{
                            border: "1px dashed",
            ...
            >
                <ModalUploadKeamanan kategori={"perkelahian"} data={json} onSuccess={(val) => {
                    setJson([])
                }} />
            </Modal>
        </>
