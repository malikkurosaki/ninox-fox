...
import ModalUploadKeamanan from "../component/modal_keamanan"

export default function ViewUploadPenipuanDanPenggelapan() {
    ...
    return (
        <>
            ...
            <Stack p={"md"}>
                ...
                >
                    <Text fw={"bold"} c={"white"} mb={20}>UPLOAD DATA INTENSITAS KEJAHATAN PENIPUAN / PENGGELAPAN</Text>
                    <Dropzone
                        loading={isLoading}
                        style={{
                            border: "1px dashed",
                                                ...
                                                <Table.Tbody>
                                                    {json.map(home =>
                                                        <Table.Tr key={home.id}>
                                                            ...
                                                            <Table.Td>{home.Meningkat}</Table.Td>
                                                            <Table.Td>{home.Menurun}</Table.Td>
                                                        </Table.Tr>
                                                    )}
                                                </Table.Tbody>
                                            </Table>
            ...
            >
                <ModalUploadKeamanan kategori={"penipuan dan penggelapan"} data={json} onSuccess={(val) => {
                    setJson([])
                }} />
            </Modal>
        </>
