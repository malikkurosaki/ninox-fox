...
import funGetPerkosaan from "../fun/get_perkosaan"
import TablePerkosaan from "../component/table_perkosaan"
import { useRouter } from "next/navigation"

export default function ViewPerkosaan({ provinsi, download, table }: { provinsi: any, download: any, table: any }) {
    ...
    async function onProses() {
        const loadData = await funGetPerkosaan({ provinsi: isProvinsi, kab: isKabupaten })
    ...
    return (
        <>
            <Stack>
                <Text fw={"bold"}>KEAMANAN - INTENSITAS KEJAHATAN PERKOSAAN/ASUSILA</Text>
            </Stack>
            <Box pt={30}>
                <SimpleGrid
                ...
                >
                    ...
                    >
                        <Box
                            ...
                            onClick={() => router.push("/dashboard/se/upload/perkosaan")}
                        >
            ...
            <Box pt={30}>
                <TablePerkosaan data={dataTable.data} title={dataTable.title} th={dataTable.thTitle} />
            </Box>
        </>
    )
}