...
import funGetPerkelahian from "../fun/get_perkelahian"
import TablePerkelahian from "../component/table_perkelahian"
import { useRouter } from "next/navigation"

export default function ViewPerkelahian({ provinsi, download, table }: { provinsi: any, download: any, table: any }) {
    ...
    async function onProses() {
        const loadData = await funGetPerkelahian({ provinsi: isProvinsi, kab: isKabupaten })
    ...
    return (
        <>
            <Stack>
                <Text fw={"bold"}>KEAMANAN - INTENSITAS PERKELAHIAN MASSAL</Text>
            </Stack>
            <Box pt={30}>
                <SimpleGrid
                ...
                >
                    ...
                    >
                        <Box
                            ...
                            onClick={() => router.push("/dashboard/se/upload/perkelahian")}
                        >
            ...
            <Box pt={30}>
                <TablePerkelahian data={dataTable.data} title={dataTable.title} th={dataTable.thTitle} />
            </Box>
        </>
    )
}