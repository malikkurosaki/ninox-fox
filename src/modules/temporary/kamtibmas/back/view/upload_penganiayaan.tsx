...
export default function ViewUploadPenganiayaan() {
    ...
    return (
        <>
            ...
            <Stack p={"md"}>
                ...
                >
                    <Text fw={"bold"} c={"white"} mb={20}>UPLOAD DATA INTENSITAS KEJAHATAN PENGANIAYAAN</Text>
                    <Dropzone
                        loading={isLoading}
                        style={{
                            border: "1px dashed",
            ...
            >
                <ModalUploadKeamanan kategori={"penganiayaan"} data={json} onSuccess={(val) => {
                    setJson([])
                }} />
            </Modal>
        </>
