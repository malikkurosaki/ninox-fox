...
import funGetJumlahDokter from "../fun/get_jumlah_dokter"
import TableJumlahDokter from "../component/table_jumlah_dokter"
import { useRouter } from "next/navigation"

export default function ViewJumlahDokter({ provinsi, download, table }: { provinsi: any, download: any, table: any }) {
    ...
    async function onProses() {
        const loadData = await funGetJumlahDokter({ provinsi: isProvinsi, kab: isKabupaten })
    ...
    return (
        <>
            <Stack>
                <Text fw={"bold"}>KESEHATAN - JUMLAH DOKTER</Text>
            </Stack>
            <Box pt={30}>
                <SimpleGrid
                ...
                >
                    ...
                    >
                        <Box
                            ...
                            onClick={() => router.push("/dashboard/se/upload/jumlah-dokter")}
                        >
            ...
            <Box pt={30}>
                <TableJumlahDokter data={dataTable.data} title={dataTable.title} th={dataTable.thTitle} />
            </Box>
        </>
    )
}