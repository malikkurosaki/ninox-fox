...
export default function ViewUploadJaminanUntukBaduta() {
    ...
    return (
        <>
            ...
            <Stack p={"md"}>
                ...
                >
                    <Text fw={"bold"} c={"white"} mb={20}>UPLOAD DATA JAMINAN KESEHATAN UNTUK BADUTA DARI KELUARGA MISKIN</Text>
                    <Dropzone
                        loading={isLoading}
                        style={{
                            border: "1px dashed",
            ...
            >
                <ModalUploadKesehatan kategori={"jaminan untuk baduta"} data={json} onSuccess={(val) => {
                    setJson([])
                }} />
            </Modal>
        </>
