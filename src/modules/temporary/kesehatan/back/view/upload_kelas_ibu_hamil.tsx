...
export default function ViewUploadKelasIbuHamil() {
    ...
    return (
        <>
            ...
            <Stack p={"md"}>
                ...
                >
                    <Text fw={"bold"} c={"white"} mb={20}>UPLOAD DATA KELAS IBU HAMIL</Text>
                    <Dropzone
                        loading={isLoading}
                        style={{
                            border: "1px dashed",
            ...
            >
                <ModalUploadKesehatan kategori={"kelas ibu hamil"} data={json} onSuccess={(val) => {
                    setJson([])
                }} />
            </Modal>
        </>
