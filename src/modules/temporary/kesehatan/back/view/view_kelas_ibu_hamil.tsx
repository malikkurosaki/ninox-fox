...
import funGetKelasIbuHamil from "../fun/get_kelas_ibu_hamil"
import TableKelasIbuHamil from "../component/table_kelas_ibu_hamil"
import { useRouter } from "next/navigation"

export default function ViewKelasIbuHamil({ provinsi, download, table }: { provinsi: any, download: any, table: any }) {
    ...
    async function onProses() {
        const loadData = await funGetKelasIbuHamil({ provinsi: isProvinsi, kab: isKabupaten })
    ...
    return (
        <>
            <Stack>
                <Text fw={"bold"}>KESEHATAN - KELAS IBU HAMIL</Text>
            </Stack>
            <Box pt={30}>
                <SimpleGrid
                ...
                >
                    ...
                    >
                        <Box
                            ...
                            onClick={() => router.push("/dashboard/se/upload/kelas-ibu-hamil")}
                        >
            ...
            <Box pt={30}>
                <TableKelasIbuHamil data={dataTable.data} title={dataTable.title} th={dataTable.thTitle} />
            </Box>
        </>
    )
}