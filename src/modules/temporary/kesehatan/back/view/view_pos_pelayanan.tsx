...
import funGetPosPelayanan from "../fun/get_pos_pelayanan"
import TablePosPelayanan from "../component/table_pos_pelayanan"
import { useRouter } from "next/navigation"

export default function ViewPosPelayanan({ provinsi, download, table }: { provinsi: any, download: any, table: any }) {
    ...
    async function onProses() {
        const loadData = await funGetPosPelayanan({ provinsi: isProvinsi, kab: isKabupaten })
    ...
    return (
        <>
                ...
                >
                    ...
                    >
                        <Box
                            ...
                            onClick={() => router.push("/dashboard/se/upload/pos-pelayanan")}
                        >
            ...
            <Box pt={30}>
                <TablePosPelayanan data={dataTable.data} title={dataTable.title} th={dataTable.thTitle} />
            </Box>
        </>
    )
}