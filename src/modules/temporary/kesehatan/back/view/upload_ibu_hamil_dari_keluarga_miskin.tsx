...
export default function ViewUploadIbuHamilDariKeluargaMiskin() {
    ...
    return (
        <>
            ...
            <Stack p={"md"}>
                ...
                >
                    <Text fw={"bold"} c={"white"} mb={20}>UPLOAD DATA JAMINAN KESEHATAN IBU HAMIL DARI KELUARGA MISKIN</Text>
                    <Dropzone
                        loading={isLoading}
                        style={{
                            border: "1px dashed",
                                                ...
                                                <Table.Tbody>
                                                    {json.map(home =>
                                                        <Table.Tr key={home.id}>
                                                            ...
                                                            <Table.Td>{home.TidakAda}</Table.Td>
                                                        </Table.Tr>
                                                    )}
                                                </Table.Tbody>
                                            </Table>
            ...
            >
                <ModalUploadKesehatan kategori={"ibu hamil dari keluarga miskin"} data={json} onSuccess={(val) => {
                    setJson([])
                }} />
            </Modal>
        </>
