...
import funGetFasilitas from "../fun/get_fasilitas"
import TableFasilitas from "../component/table_fasilitas"
import { useRouter } from "next/navigation"

export default function ViewFasilitas({ provinsi, download, table }: { provinsi: any, download: any, table: any }) {
    ...
    async function onProses() {
        const loadData = await funGetFasilitas({ provinsi: isProvinsi, kab: isKabupaten })
    ...
    return (
        <>
            <Stack>
                <Text fw={"bold"}>KESEHATAN - JUMLAH FASILITAS KESEHATAN</Text>
            </Stack>
            <Box pt={30}>
                <SimpleGrid
                ...
                >
                    ...
                    >
                        <Box
                            ...
                            onClick={() => router.push("/dashboard/se/upload/fasilitas")}
                        >
            ...
            <Box pt={30}>
                <TableFasilitas data={dataTable.data} title={dataTable.title} th={dataTable.thTitle} />
            </Box>
        </>
    )
}