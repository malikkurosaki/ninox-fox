...
import funGetJaminanUntukBaduta from "../fun/get_jaminan_untuk_baduta"
import TableJaminanUntukBaduta from "../component/table_jaminan_untuk_baduta"
import { useRouter } from "next/navigation"

export default function ViewJaminanUntukBaduta({ provinsi, download, table }: { provinsi: any, download: any, table: any }) {
    ...
    async function onProses() {
        const loadData = await funGetJaminanUntukBaduta({ provinsi: isProvinsi, kab: isKabupaten })
    ...
    return (
        <>
            <Stack>
                <Text fw={"bold"}>KESEHATAN - JAMINAN KESEHATAN UNTUK ANAK BADUTA DARI KELUARGA MISKIN</Text>
            </Stack>
            <Box pt={30}>
                <SimpleGrid
                ...
                >
                    ...
                    >
                        <Box
                            ...
                            onClick={() => router.push("/dashboard/se/upload/jaminan-untuk-baduta")}
                        >
            ...
            <Box pt={30}>
                <TableJaminanUntukBaduta data={dataTable.data} title={dataTable.title} th={dataTable.thTitle} />
            </Box>
        </>
    )
}