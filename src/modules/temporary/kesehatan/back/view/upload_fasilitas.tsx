...
export default function ViewUploadFasilitas() {
    ...
    async function onLoad(data: any) {
        if (data.length > 0) {
            ...
            if (('id' in data[0]) &&
                ...
                ('Kabkot' in data[0]) &&
                ('Kecamatan' in data[0]) &&
                ('RumahSakit' in data[0]) &&
                ('RumahBersalin' in data[0]) &&
                ('RumahSakitBersalin' in data[0]) &&
                ('TempatPraktekBidan' in data[0]) &&
                ('Apotek' in data[0]) &&
                ('PuskesmasDenganRawatInap' in data[0]) &&
                ('PuskesmasTanpaRawatInap' in data[0])) {
    ...
    return (
        <>
            ...
            <Stack p={"md"}>
                ...
                >
                    <Text fw={"bold"} c={"white"} mb={20}>UPLOAD DATA JUMLAH FASILITAS KESEHATAN</Text>
                    <Dropzone
                        loading={isLoading}
                        style={{
                            border: "1px dashed",
                                            ...
                                            >
                                                <Table.Thead>
                                                    ...
                                                    >
                                                        ...
                                                        <Table.Th>Puskesmas Dengan Rawat Inap</Table.Th>
                                                ...
                                                <Table.Tbody>
                                                    {json.map(home =>
                                                        <Table.Tr key={home.id}>
                                                            ...
                                                            <Table.Td>{home.RumahSakit}</Table.Td>
                                                            <Table.Td>{home.RumahBersalin}</Table.Td>
                                                            <Table.Td>{home.RumahSakitBersalin}</Table.Td>
                                                            <Table.Td>{home.TempatPraktekBidan}</Table.Td>
                                                            <Table.Td>{home.Apotek}</Table.Td>
                                                            <Table.Td>{home.PuskesmasDenganRawatInap}</Table.Td>
                                                            <Table.Td>{home.PuskesmasTanpaRawatInap}</Table.Td>
                                                        </Table.Tr>
                                                    )}
                                                </Table.Tbody>
                                            </Table>
            ...
            >
                <ModalUploadKesehatan kategori={"fasilitas"} data={json} onSuccess={(val) => {
                    setJson([])
                }} />
            </Modal>
        </>
