...
import funGetIbuHamilDariKeluargaMiskin from "../fun/get_ibu_hamil_dari_keluarga_miskin"
import TableIbuHamilDariKeluargaMiskin from "../component/table_ibu_hamil_dari_keluarga_miskin"
import { useRouter } from "next/navigation"

export default function ViewIbuHamilDariKeluargaMiskin({ provinsi, download, table }: { provinsi: any, download: any, table: any }) {
    ...
    async function onProses() {
        const loadData = await funGetIbuHamilDariKeluargaMiskin({ provinsi: isProvinsi, kab: isKabupaten })
    ...
    return (
        <>
            <Stack>
                <Text fw={"bold"}>KESEHATAN - JAMINAN KESEHATAN IBU HAMIL DARI KELUARGA MISKIN</Text>
            </Stack>
            <Box pt={30}>
                <SimpleGrid
                ...
                >
                    ...
                    >
                        <Box
                            ...
                            onClick={() => router.push("/dashboard/se/upload/ibu-hamil-dari-keluarga-miskin")}
                        >
            ...
            <Box pt={30}>
                <TableIbuHamilDariKeluargaMiskin data={dataTable.data} title={dataTable.title} th={dataTable.thTitle} />
            </Box>
        </>
    )
}