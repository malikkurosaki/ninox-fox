...
export default function ViewUploadJaminanPensiun() {
    ...
    return (
        <>
            ...
            <Stack p={"md"}>
                ...
                >
                    <Text fw={"bold"} c={"white"} mb={20}>UPLOAD DATA JAMINAN PENSIUN</Text>
                    <Dropzone
                        loading={isLoading}
                        style={{
                            border: "1px dashed",
            ...
            >
                <ModalUploadKetenagakerjaan kategori={"jaminan pensiun"} data={json} onSuccess={(val) => {
                    setJson([])
                }} />
            </Modal>
        </>
