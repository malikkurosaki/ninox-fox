...
import funGetJaminanPensiun from "../fun/get_jaminan_pensiun"
import TableJaminanPensiun from "../component/table_jaminan_pensiun"
import { useRouter } from "next/navigation"

export default function ViewJaminanPensiun({ provinsi, download, table }: { provinsi: any, download: any, table: any }) {
    ...
    async function onProses() {
        const loadData = await funGetJaminanPensiun({ provinsi: isProvinsi, kab: isKabupaten })
    ...
    return (
        <>
            <Stack>
                <Text fw={"bold"}>KETENAGAKERJAAN - JAMINAN PENSIUN</Text>
            </Stack>
            <Box pt={30}>
                <SimpleGrid
                ...
                >
                    ...
                    >
                        <Box
                            ...
                            onClick={() => router.push("/dashboard/se/upload/jaminan-pensiun")}
                        >
            ...
            <Box pt={30}>
                <TableJaminanPensiun data={dataTable.data} title={dataTable.title} th={dataTable.thTitle} />
            </Box>
        </>
    )
}