...
import ModalUploadKetenagakerjaan from "../component/modal_ketenagakerjaan"

export default function ViewUploadJaminanKecelakaanKerja() {
    ...
    return (
        <>
            ...
            <Stack p={"md"}>
                ...
                >
                    <Text fw={"bold"} c={"white"} mb={20}>UPLOAD DATA JAMINAN KECELAKAAN KERJA</Text>
                    <Dropzone
                        loading={isLoading}
                        style={{
                            border: "1px dashed",
                                            ...
                                            >
                                                <Table.Thead>
                                                    ...
                                                    >
                                                        ...
                                                        <Table.Th>Ya</Table.Th>
                                                        <Table.Th>Tidak</Table.Th>
                                                        <Table.Th>Tidak Tahu</Table.Th>
                                                    </Table.Tr>
                                                </Table.Thead>
                                                <Table.Tbody>
                                                    {json.map(home =>
                                                        <Table.Tr key={home.id}>
                                                            ...
                                                            <Table.Td>{home.Ya}</Table.Td>
                                                            <Table.Td>{home.Tidak}</Table.Td>
                                                            <Table.Td>{home.TidakTahu}</Table.Td>
                                                        </Table.Tr>
                                                    )}
                                                </Table.Tbody>
                                            </Table>
            ...
            >
                <ModalUploadKetenagakerjaan kategori={"jaminan kecelakaan kerja"} data={json} onSuccess={(val) => {
                    setJson([])
                }} />
            </Modal>
        </>
