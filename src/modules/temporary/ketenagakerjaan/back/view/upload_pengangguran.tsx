...
export default function ViewUploadPengangguran() {
    ...
    return (
        <>
            ...
            <Stack p={"md"}>
                ...
                >
                    <Text fw={"bold"} c={"white"} mb={20}>UPLOAD DATA PENGANGGURAN</Text>
                    <Dropzone
                        loading={isLoading}
                        style={{
                            border: "1px dashed",
            ...
            >
                <ModalUploadKetenagakerjaan kategori={"pengangguran"} data={json} onSuccess={(val) => {
                    setJson([])
                }} />
            </Modal>
        </>
