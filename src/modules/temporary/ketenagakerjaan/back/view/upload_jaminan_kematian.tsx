...
export default function ViewUploadJaminanKematian() {
    ...
    return (
        <>
            ...
            <Stack p={"md"}>
                ...
                >
                    <Text fw={"bold"} c={"white"} mb={20}>UPLOAD DATA JAMINAN KEMATIAN</Text>
                    <Dropzone
                        loading={isLoading}
                        style={{
                            border: "1px dashed",
            ...
            >
                <ModalUploadKetenagakerjaan kategori={"jaminan kematian"} data={json} onSuccess={(val) => {
                    setJson([])
                }} />
            </Modal>
        </>
