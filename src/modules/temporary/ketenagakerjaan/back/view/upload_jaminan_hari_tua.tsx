...
export default function ViewUploadJaminanHariTua() {
    ...
    return (
        <>
            ...
            <Stack p={"md"}>
                ...
                >
                    <Text fw={"bold"} c={"white"} mb={20}>UPLOAD DATA JAMINAN HARI TUA</Text>
                    <Dropzone
                        loading={isLoading}
                        style={{
                            border: "1px dashed",
            ...
            >
                <ModalUploadKetenagakerjaan kategori={"jaminan hari tua"} data={json} onSuccess={(val) => {
                    setJson([])
                }} />
            </Modal>
        </>
