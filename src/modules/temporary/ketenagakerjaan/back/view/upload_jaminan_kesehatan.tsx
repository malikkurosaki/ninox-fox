...
export default function ViewUploadJaminanKesehatan() {
    ...
    return (
        <>
            ...
            <Stack p={"md"}>
                ...
                >
                    <Text fw={"bold"} c={"white"} mb={20}>UPLOAD DATA JAMINAN KESEHATAN</Text>
                    <Dropzone
                        loading={isLoading}
                        style={{
                            border: "1px dashed",
            ...
            >
                <ModalUploadKetenagakerjaan kategori={"jaminan kesehatan"} data={json} onSuccess={(val) => {
                    setJson([])
                }} />
            </Modal>
        </>
