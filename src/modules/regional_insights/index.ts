...
import funGetEmotionDetailRegionalNew from "./fun/get_emotion_detail_regional_new";
import funGetEmotionRegionalInsight from "./fun/get_emotion_regional_insight";
import funGetEmotionRegionalInsightNew from "./fun/get_emotion_regional_insight_new";
...
export { funGetEmotionRegionalInsightNew }
export { funGetEmotionDetailRegionalNew }
export { isDetactionNavbar }