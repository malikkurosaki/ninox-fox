...
import UploadDataModal from "./modal/upload_data_modal";


/**
 * Fungsi menampilkan halaman upload data.
  * @param {Component} props mengambil file.
 * @returns  Hasil dari upload data popularity untuk upload file yang di butuhkan
 */

export default function UploadDataPopularity(props: Partial<DropzoneProps>) {
    ...
    <>
      ...
      <Box pt={20}>
        ...
        >
          ...
          <Center pt={20}>
              <Button bg={"white"} c={"dark"} onClick={() => setOpenModal(true)}>UPDATE</Button>
          </Center>
        </Box>
      </Box>
      <Modal
