...
import { ViewDetailRegionalInsights, funGetEmotionDetailRegional } from '@/modules/regional_insights'
...
export default async function Page({ params }: { params: { idCandidate: string, idArea: string } }) {
  ...
  return (
    <ViewDetailRegionalInsights rhi={dataRhi} area={dataDb.area} emotion={dataDb.data} audience={dataAudience} pct={dataPct} lta={dataLta} />
  )
}
